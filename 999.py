...
for i in range(len(jjck)):
    ...
    try:
        resp_user = requests.get('https://mc.999.com.cn/zanmall_diy/ma/personal/user/info', headers=headers, verify=False)
        ...
        for i in range(5):
            ...
            resp_read = requests.post('https://mc.999.com.cn/zanmall_diy/ma/client/pointTaskClient/finishTask',
                                             headers=headers, json=data_read, verify=False)
        ...
        for i in range(3):
            ...
            resp_htest = requests.post('https://mc.999.com.cn/zanmall_diy/ma/health/add',
                                      headers=headers, json=h_test, verify=False)
            ...
            resp_h_test = requests.post('https://mc.999.com.cn/zanmall_diy/ma/client/pointTaskClient/finishTask',
                                      headers=headers, json=data_h_test, verify=False)
        ...
        # 获取总积分并推送消息
        try:
            resp = requests.get('https://mc.999.com.cn/zanmall_diy/ma/personal/point/pointInfo', headers=headers, verify=False)
